...
export const aboutContent = {
  ...
  intro: [
    ...
    "Dejé la universidad porque no aprendía cosas útiles para la vida real. Fui voluntario en Bruselas, en Hong Kong enseñé idiomas, trabajé de relaciones públicas y de extra en películas, empecé un ausbildung en Roding — Baviera, cerca de la República Checa — y a los seis meses me mudé a Leipzig. Ahí vi un cartel en un restaurante español y acabé de cocinero; también lavaplatos, carpas y placas solares. Viajé por Sudamérica y decidí irme a Suiza.",
    "En Suiza fui ferrallista, después en una cadena de comida rápida, un restaurante mexicano del que me echaron, temporero en una obra, cartero — me llamaron por teléfono mientras estaba en la obra —, reparto de comida en bici eléctrica y paquetes en moto. A Argentina fui cuando empecé a ordenar mi vida con la matriz de Eisenhower, de Los 7 hábitos de Stephen Covey. Estudié diseño UX online y me metí en programación porque los trabajos pedían HTML y CSS. Desde Málaga di soporte SAP HCM a trabajadores de una gran cadena de supermercados. Volví a Göttingen — el puesto se llamaba SAP HXM Consultant, pero era desarrollador con SAPUI5 y Vue.js — y de ahí me echaron. Terminé vendiendo mi piso en Málaga para empezar de cero en Tbilisi.",
