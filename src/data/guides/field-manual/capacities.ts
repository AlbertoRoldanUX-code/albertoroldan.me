    ...
    subsections: [
      {
        ...
        paragraphs: [
          ...
          "La mayoría espera el permiso, el título, el curso terminado, el porfolio perfecto. Yo hice lo contrario: me metí en programación porque muchas ofertas de UX pedían HTML y CSS, sin esperar a dominar esas tecnologías. Aprendí haciendo. Eso no es valentía. Es la única forma que conozco de descubrir si algo merece tu tiempo.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Cuando me despidieron de un puesto de desarrollador, lo interpreté como un veredicto sobre mi valía, en lugar de verlo como un dato sobre el encaje. Perdí meses buscando la siguiente etiqueta correcta en lugar de probar algo pequeño.",
          "En Suiza ya había hecho lo más duro que he hecho en la vida: ferrallista. Lo más duro no fue solo el cuerpo. Fueron las faltas de respeto. Pero también aprendí que podía entrar en un mercado sin estar «preparado».",
          "Perdí meses preparándome para moverme en lugar de moverme. Leyendo sobre programación en lugar de escribir código malo. El coste no fue solo el tiempo. Fue la información que nunca recibí porque nunca lancé nada.",
        ],
      },
      {
        heading: "Cómo se veía cuando la desarrollé",
        paragraphs: [
          "Mi primer mes en Suiza no fue como consultor. Fue como ferrallista. Después comida rápida, un restaurante mexicano del que me echaron, temporero en una obra, cartero y reparto en bici y moto. Nada de eso estaba en ningún plan. Todo me enseñó que el permiso llega después, no antes.",
          "Cuando me metí en programación, no esperé a dominar un conjunto completo de tecnologías. Abrí un editor y empecé a construir cosas rotas. Aprendí haciendo, no esperando el título perfecto.",
          "Con el vino georgiano no monté una operación perfecta. Publiqué, contacté clientes en España, hice un pedido de prueba. Y las cajas llegaron rotas. Eso también son datos: puede haber interés y, aun así, la logística puede destruir el margen si no la diseñas.",
          "Publiqué en LinkedIn antes de tener producto pulido. Publicar fue la prueba.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Alguien sin ella tiene una idea el lunes, pasa tres meses construyendo la versión perfecta, y cuando lanza está agotado, demasiado implicado emocionalmente, y destrozado si no funciona de inmediato. O nunca lanza.",
        ],
      },
      {
      ...
      },
      {
        ...
        steps: [
          ...
          {
            label: "Paso 2:",
            text: "Define la versión más cutre posible. Una publicación en LinkedIn preguntando si pagarían por X. Un PDF de una página. Una página sencilla con un botón de reserva. No gastes dinero. Límite: 48 horas.",
          },
          {
            label: "Paso 3:",
            text: "Lánzala. Ponla delante de al menos 10 personas reales. Mensajes directos, publicación pública, correo electrónico a contactos. Busca reacciones honestas, no apoyo de amigos.",
          },
          {
            label: "Paso 4:",
    ...
    subsections: [
      {
        heading: "Qué es",
        paragraphs: [
          "La capacidad de interpretar lo que el mercado te dice de verdad: ventas, mensajes, preguntas de compra. No lo que te gustaría que te dijera.",
          "Las opiniones son baratas. «Me encanta la idea» no paga facturas. Un mensaje directo preguntando por el precio sí. Una venta sí. Un cliente que repite sí.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "En LinkedIn, mis publicaciones sobre temas que a mí me interesaban generaban likes. Las publicaciones sobre problemas concretos que la gente quería resolver generaban mensajes directos y ventas. Durante meses presté más atención a los likes.",
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Con los tours publiqué la oferta y mandé correos electrónicos antes de montar la operación completa. Casi nadie respondió. Eso también era una señal, y me ahorró meses construyendo algo que nadie pedía.",
          "Con un producto de IA que vendí durante un año, aprendí la diferencia entre «demostración interesante» y «cliente que paga y se queda». Algunos pagaron unos meses. Otros meses de conversación sin cierre. Los datos decían algo que no quería oír: ciclo largo, importe medio bajo, mercado con poca diferenciación.",
          "La regla que uso ahora: publicar antes de construir. Si nadie reacciona a la publicación, no construyo el producto entero.",
        ],
      },
      {
        heading: "Qué te cuesta si nunca la desarrollas",
        paragraphs: [
          "Construyes cosas que nadie quiere y te preguntas por qué no funcionan. Trabajas más duro: más funciones, más contenido, más anuncios. Sin abordar el problema de fondo: estás resolviendo lo incorrecto.",
      ...
      },
      {
        heading: "El error común",
        paragraphs: [
          "Confundir señales de vanidad con señales reales. Likes y seguidores importan, pero son más débiles que ingresos y mensajes directos. En un negocio, la señal más fuerte suele ser que alguien pague, repita o recomiende el producto. La segunda es una «pregunta de compra»: alguien que se toma la molestia de preguntarte precio, plazos o disponibilidad.",
        ],
      },
      {
        heading: "El ejercicio",
        ...
        steps: [
          {
            label: "Paso 1:",
            text: "Recopila datos de los últimos 90 días: interacción, ventas, mensajes directos, correos electrónicos, preguntas de clientes, reembolsos. Escríbelo sin filtrar.",
          },
          {
            label: "Paso 2:",
        ...
        outcome:
          "Has identificado algo que ignorabas y el mercado te dice que importa. La decisión puede resultar incómoda porque contradice el plan que tenías. Lo importante es que esté respaldada por señales reales.",
      },
    ],
  },
  {
    ...
    subsections: [
      {
        ...
        paragraphs: [
          ...
          "Cuando me despidieron, lo que me quedó no fue el puesto. Fueron las habilidades: resolver problemas, comunicar, aprender bajo presión. Nadie me las quitó.",
          "Las habilidades transferibles son uno de los pocos activos que cruzan fronteras contigo.",
        ],
      },
      {
        heading: "Qué me costó no tenerla al principio",
        paragraphs: [
          ...
          "Cuando me echaron del puesto de desarrollador, me di cuenta de que había construido sobre algo frágil: la aprobación de otros. No había invertido lo suficiente en lo mío.",
        ],
      },
      {
        heading: "Cómo se veía cuando la desarrollé",
        paragraphs: [
          "Me metí en programación porque muchas ofertas de UX pedían HTML y CSS. Nadie me dio permiso. Lo hice porque necesitaba otra opción cuando el empleo desapareció.",
          "Desarrollé mis habilidades de venta haciendo demostraciones y propuestas reales, y trabajando con clientes que pagaron y después se fueron. Aprendí a escribir publicando cada semana. Los idiomas que hablo no los estudié en abstracto: los necesité para trabajar, vender y vivir.",
        ],
      },
      {
        heading: "Qué te cuesta si nunca la desarrollas",
